...
public class MailJetSES {
	...
	final String PASSOWRD_RESET_HTML_BODY = "<h1>Reset Your Password</h1> "
			+ "<p>Aoba $firstName </p>"
	...
	public void verifyEmail(UserDto userDto) {
		...
		request = new MailjetRequest(Emailv31.resource).property(Emailv31.MESSAGES, new JSONArray().put(new JSONObject()
				.put(Emailv31.Message.FROM,
						new JSONObject().put("Email", userDto.getEmail()).put("Name", userDto.getFirstName()))
				.put(Emailv31.Message.TO,
						new JSONArray()
								.put(new JSONObject().put("Email", userDto.getEmail()).put("Name", "Matheus")))
				.put(Emailv31.Message.SUBJECT, "Verify from Mailjet.")
				.put(Emailv31.Message.TEXTPART, TEXT_BODY)
				.put(Emailv31.Message.HTMLPART, htmlWithToken)
	...
	public boolean sendPasswordResetRequest (String firstName, String email, String token) {
		...
		request = new MailjetRequest(Emailv31.resource).property(Emailv31.MESSAGES, new JSONArray().put(new JSONObject()
				.put(Emailv31.Message.FROM,				
						new JSONObject().put("Email", email).put("Name", firstName))
				.put(Emailv31.Message.TO,
						new JSONArray()
								.put(new JSONObject().put("Email", email).put("Name", "Matheus")))
				.put(Emailv31.Message.SUBJECT, PASSWORD_RESET_SUBJECT)
				.put(Emailv31.Message.TEXTPART, TEXT_BODY)
